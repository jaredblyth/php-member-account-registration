...
<?php // 
/* This script registers a member and creates a directory for them. */
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
	...
	if (!$problem) { // If there weren't any problems...
			...
			// Create the member_subdirectory name to be written:
...
// Define the query:
		$query = "INSERT INTO members (member_id, first_name, last_name, member_email, member_password, date_registered, member_age, member_sex, member_location, member_subdirectory) VALUES (0, '{$_POST['first_name']}', '{$_POST['last_name']}', '{$_POST['email']}', '{$_POST['password1']}', NOW(), '{$_POST['member_age']}', '{$_POST['member_sex']}', '{$_POST['member_location']}', $subdir)";
		...
		if (@mysql_query($query, $dbc)) {
			...
			setcookie('Subdirectory', $subdir, time()+3600);


			print '<p align="center"><font color="red"><h2>You have been registered as a member!</h2> <h2><a href="member-account.php">Click here</a> to access your account</h2></font></p><p>';
...
// Create the form:
?>
<form action="member-account-register.php" method="post">

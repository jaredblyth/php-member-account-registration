...
if (!is_administrator()) {
	...
	</form><br/><a href="member-account-register.php" "title="Register so that you can access our members area and take advantage of our special features."><b>Register</a> as a member</b><p><p></div><p>';
	exit();
}
?>